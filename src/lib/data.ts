...
export const opportunities: Opportunity[] = [
  ...
  },
  {
    ...
    guidelines: "Submit using a complete Hackathon Template, Startup Template, or relevant completed document.",
    benefits: "Prize pool, demo stage, technical mentors, and sponsor review.",
    requirements: ["Complete Idea Workspace document", "Demo link or build plan", "Team members"],
...
export const applications: Application[] = [
  ...
  },
  {
    ...
    idea_workspace_id: null,
    startup: "VoltRoute",
    founder: "Aarav Mehta",
    reviewer: "Venture Connect Events",
    opportunity: "Frontier Founder Demo Day",
    opportunityType: "Startup event",
    status: "Submitted",
    submittedAt: "2026-07-07",
    packet: ["Event registration", "Guidelines read"],
    timeline: [{ label: "Submitted", date: "Jul 7", complete: true }]
  }
];
