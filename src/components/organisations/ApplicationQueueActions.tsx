...
import { Bookmark, CheckCircle2, LoaderCircle, MessageSquareMore, SearchCheck, XCircle } from "lucide-react";
import { Button } from "@/components/ui/Button";
import { StatusMessage } from "@/components/ui/FeedbackState";

type Action = "save" | "under_review" | "request_information" | "interested" | "shortlist" | "select" | "waitlist" | "decline";
...
export function ApplicationQueueActions({ applicationId, organiserMode = false }: { applicationId: string; organiserMode?: boolean }) {
  ...
  const actions: Array<[Action, string, typeof Bookmark]> = organiserMode
    ...
    : [["save", "Save", Bookmark], ["under_review", "Under review", SearchCheck], ["request_information", "Request information", MessageSquareMore], ["interested", "Interested", CheckCircle2], ["decline", "Decline", XCircle]];
