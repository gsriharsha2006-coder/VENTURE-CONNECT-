...
export default async function FormBuilderPage() {
  const { profile, supabase } = await requireRole(["hackathon_organizer"]);
  ...
  return <div className="space-y-6"><PageHeader eyebrow="Hackathon organiser" title="Registration Form" description="Configure a simple internal hackathon registration form. This flow never invokes Idea Workspace or Application Quality Check." /><FormBuilderManager initialForms={initialForms} /></div>;
}
